    ...
    enroll(function(err, enrolleduser) {
        ...
        invoke(enrolleduser, msg_id, timestamp, current_temperature, humid, function(err, results) {
            ...
            /*if(results.result == 200) {
                                var string1 = "{\"queryresult\"" + ":[";
                                var string2 = "]}";
                                query(enrolleduser, msg_id, function(err, results) {
                                        if (err) {
                                                console.log('***********Unknown Error');
                                                return;
                                        }
            ...
            if (strStatus.status == "Valid") {
                ...
                var reqs = http.request(options, function(respose) {
                    ...
                    respose.on('end', function() {
                        console.log("smart contract conditions are statisfied and shuting down the device");
                    });
                });
                reqs.end();
            } else {
                console.log("Status is Invalid , Hence not abe to call the service")
            }
